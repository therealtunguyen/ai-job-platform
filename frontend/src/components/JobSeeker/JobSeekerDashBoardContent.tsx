    ...
    const fetchDashboardStats = async () => {
      ...
      try {
        ...
        const applicationsResponse = await axiosInstance.get(
          API_PATHS.APPLICATIONS.GET_USER_APPLICATIONS.replace(':userId', user.id.toString())
        );
        ...
        const profileResponse = await axiosInstance.get(API_PATHS.USERS.GET_PROFILE);
        const profileCompleteness = calculateProfileCompleteness(profileResponse.data);
        
        setStats({
          appliedJobs: applicationsResponse.data?.applications?.length || applicationsResponse.data?.length || 0,
          interviews: interviewsResponse.data?.interviews?.length || interviewsResponse.data?.length || 0,
    ...
    return (
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center justify-between rounded-lg bg-white p-6 shadow-md animate-pulse">
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex items-center justify-between rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-blue-600">{stats.appliedJobs}</p>
        ...
        <div className="flex items-center justify-between rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-green-600">{stats.savedJobs}</p>
        ...
        <div className="flex items-center justify-between rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-orange-600">{stats.profileCompleteness}%</p>
