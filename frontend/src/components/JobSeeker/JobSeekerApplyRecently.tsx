    ...
    <div className='p-8'>
      <div className='bg-white rounded-xl shadow-lg border border-gray-100'>
        <div className='p-6 border-b border-gray-200'>
          <h2 className='text-2xl font-bold text-gray-800 mb-2'>Jobs Applied Recently</h2>
          <p className='text-gray-600'>Track your recent job applications and their status</p>
        </div>
        <div className="p-6">
