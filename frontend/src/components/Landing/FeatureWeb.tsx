      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="mb-16 text-center">
          <h2 className="mb-6 text-4xl font-bold text-gray-900 md:text-5xl">
            ...
            <span className="block bg-gradient-to-r from-[#29436c] to-[#90ad71] bg-clip-text text-transparent">
              Succeed
            </span>
          </h2>
          ...
          <div className="">
            ...
            <div className="space-y-8">
              {jobSeekerFeatures.map((feature, index) => (
                <div
                  className="group flex w-full cursor-pointer items-center space-x-4 rounded-2xl p-6 transition-all duration-300 hover:bg-blue-50"
                  key={index}
                >
          ...
          <div className="">
            ...
            <div className="space-y-8">
              {employerFeatures.map((feature, index) => (
                <div
                  className="group flex w-full cursor-pointer items-center space-x-4 rounded-2xl p-6 transition-all duration-300 hover:bg-green-50"
                  key={index}
                >
