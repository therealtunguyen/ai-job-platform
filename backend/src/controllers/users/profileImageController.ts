...
import { uploadAndSetProfileImage, deleteProfileImage as deleteProfileImageService } from "../../services/users/profileImageService";
...
export const deleteProfileImage = async (req: Request, res: Response) => {
    try {
        ...
        const deleteResult = await deleteProfileImageService(userId, userProfileForDelete.user_type);
